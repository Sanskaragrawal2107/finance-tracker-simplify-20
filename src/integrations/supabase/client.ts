...
export const fetchSiteFinancialSummary = async (siteId: string): Promise<BalanceSummary | null> => {
  try {
    ...
    // Fetch total funds received separately
    ...
    console.log('Total funds received calculated:', totalFundsReceived);
    
    if (!summaryData) return null;
    
    // Transform the data to match the expected BalanceSummary format
    // Include the funds received from our separate calculation
    return {
